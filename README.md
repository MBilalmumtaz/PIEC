...
**Fixed in latest version.** The URDF mesh orientation and wheel axes have been corrected.
...
3. In RViz, robot should move forward (positive X direction)

**If still reversed:**
- Check that you're using the latest URDF files
- Verify `scout_mini.urdf.xacro` has `rpy="0 0 0"` for base_link (NOT `rpy="1.57 0 1.57"`)
- Verify wheel axes are `xyz="0 0 1"` (NOT `xyz="0 0 -1"`)
